...
public class TheCrownPart2Controller implements Initializable {
    ...
    private String meditationImagePath = "file:Resources/Meditation/Crown/CrownChakra.png";
    private String meditation1ImagePath = "file:Resources/Meditation/Crown/CrownChakra1.png";
    private String meditation2ImagePath = "file:Resources/Meditation/Crown/CrownChakra2.png";
    private String meditation3ImagePath = "file:Resources/Meditation/Crown/CrownChakra3.png";
    ...
    @FXML
    void handleCrownChakraMeditation(MouseEvent event) {
     	vboxOne.setTranslateX(-450);
    	WindowEditor.setTransition(vboxOne, "x", 450, 0);
     	loadNextScene(meditationImagePath, "Length: 10 minutes", "Name: Balancing crown chakra meditation", vboxOne, meditation, MeditateState.MEDITATION);
    }
    
    @FXML
    void handleCrownChakraMeditation1(MouseEvent event) {
    	vboxTwo.setTranslateX(-450);
     	vboxTwo.setTranslateY(-200);
    	WindowEditor.setTransition(vboxTwo, "xy", 0, 0);
    	loadNextScene(meditation1ImagePath, "Length: 30 minutes", "Name: Deep crown chakra meditation", vboxTwo, meditation1, MeditateState.MEDITATION1);
    }
    
    @FXML
    void handleCrownChakraMeditation2(MouseEvent event) {
    	vboxThree.setTranslateX(-450);
    	vboxThree.setTranslateY(-400);
    	WindowEditor.setTransition(vboxThree, "xy", 0, 0);
    	loadNextScene(meditation2ImagePath, "Length: 15 minutes", "Name: Powerful Crown Chakra Meditation", vboxThree, meditation2, MeditateState.MEDITATION2);
    }

    @FXML
    void handleCrownChakraMeditation3(MouseEvent event) {
    	vboxFour.setTranslateX(-450);
    	vboxFour.setTranslateY(-600);
    	WindowEditor.setTransition(vboxFour, "xy", 0, 0);
    	loadNextScene(meditation3ImagePath, "Length: 60 minutes", "Name: Extremelly powerful crown chakra meditation", vboxFour, meditation3, MeditateState.MEDITATION3);
    }
    ...
    private void handleMeditate(String imagePath, MeditateState medState) {
    	...
    	if(medState == MeditateState.MEDITATION)
    		musicPlayer.playMusic("Resources/Meditation/Crown/CrownChakraMeditation.mp3");
    	else if(medState == MeditateState.MEDITATION1)
    		musicPlayer.playMusic("Resources/Meditation/Crown/CrownChakraMeditation1.mp3");
    	else if(medState == MeditateState.MEDITATION2)
    		musicPlayer.playMusic("Resources/Meditation/Crown/CrownChakraMeditation2.mp3");
    	else if(medState == MeditateState.MEDITATION3)
    		musicPlayer.playMusic("Resources/Meditation/Crown/CrownChakraMeditation3.mp3");
