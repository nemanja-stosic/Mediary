...
public class TheBrowPart2GuidedController implements Initializable {
    ...
    private String guidedImagePath = "file:Resources/Meditation/Brow.guided/BrowChakraGuided.png";
    private String guided1ImagePath = "file:Resources/Meditation/Brow.guided/BrowChakraGuided1.png";
    private String guided2ImagePath = "file:Resources/Meditation/Brow.guided/BrowChakraGuided2.png";
    private String guided3ImagePath = "file:Resources/Meditation/Brow.guided/BrowChakraGuided3.png";
    ...
    @FXML
    void handleBrowChakraGuided(MouseEvent event) {
     	vboxOne.setTranslateX(-450);
    	WindowEditor.setTransition(vboxOne, "x", 450, 0);
     	loadNextScene(guidedImagePath, "Length: 14 minutes", "Name: Activating Qi Flow of Third Eye Chakra Meditation \n(Sixth Chakra)", vboxOne, meditation, MeditateState.GUIDED);
    }
    
    @FXML
    void handleBrowChakraGuided1(MouseEvent event) {
    	vboxTwo.setTranslateX(-450);
     	vboxTwo.setTranslateY(-200);
    	WindowEditor.setTransition(vboxTwo, "xy", 0, 0);
    	loadNextScene(guided1ImagePath, "Length: 28 minutes", "Name: Third Eye Activation Guided Meditation (Brow Chakra)", vboxTwo, meditation1, MeditateState.GUIDED1);
    }
    
    @FXML
    void handleBrowChakraGuided2(MouseEvent event) {
    	vboxThree.setTranslateX(-450);
    	vboxThree.setTranslateY(-400);
    	WindowEditor.setTransition(vboxThree, "xy", 0, 0);
    	loadNextScene(guided2ImagePath, "Length: 15 minutes", "Name: Third Eye Chakra Balancing Guided Meditation", vboxThree, meditation2, MeditateState.GUIDED2);
    }

    @FXML
    void handleBrowChakraGuided3(MouseEvent event) {
    	vboxFour.setTranslateX(-450);
    	vboxFour.setTranslateY(-600);
    	WindowEditor.setTransition(vboxFour, "xy", 0, 0);
    	loadNextScene(guided3ImagePath, "Length: 10 minutes", "Name: Guided Brow Chakra Meditation", vboxFour, meditation3, MeditateState.GUIDED3);
    }
    ...
    private void handleMeditate(String imagePath, MeditateState medState) {
    	...
    	if(medState == MeditateState.GUIDED)
    		musicPlayer.playMusic("Resources/Meditation/Brow.guided/BrowChakraGuided.mp3");
    	else if(medState == MeditateState.GUIDED1)
    		musicPlayer.playMusic("Resources/Meditation/Brow.guided/BrowChakraGuided1.mp3");
    	else if(medState == MeditateState.GUIDED2)
    		musicPlayer.playMusic("Resources/Meditation/Brow.guided/BrowChakraGuided2.mp3");
    	else if(medState == MeditateState.GUIDED3)
    		musicPlayer.playMusic("Resources/Meditation/Brow.guided/BrowChakraGuided3.mp3");
