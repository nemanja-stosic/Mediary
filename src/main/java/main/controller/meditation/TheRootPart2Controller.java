...
public class TheRootPart2Controller implements Initializable {
    ...
    private String meditationImagePath = "file:Resources/Meditation/Root/RootChakra.png";
    private String meditation1ImagePath = "file:Resources/Meditation/Root/RootChakra1.png";
    private String meditation2ImagePath = "file:Resources/Meditation/Root/RootChakra2.png";
    private String meditation3ImagePath = "file:Resources/Meditation/Root/RootChakra3.png";
    ...
    @FXML
    void handleRootChakraMeditation(MouseEvent event) {
        vboxOne.setTranslateX(-450);
        WindowEditor.setTransition(vboxOne, "x", 450, 0);
        loadNextScene(meditationImagePath, "Length: 15 minutes", "Name: Balancing and activation of root chakra", vboxOne, meditation, MeditateState.MEDITATION);
    }

    @FXML
    void handleRootChakraMeditation1(MouseEvent event) {
        vboxTwo.setTranslateX(-450);
        vboxTwo.setTranslateY(-200);
        WindowEditor.setTransition(vboxTwo, "xy", 0, 0);
        loadNextScene(meditation1ImagePath, "Length: 25 minutes", "Name: Root chakra meditation\n Note: you can use LAM mantra for this meditation if you want.", vboxTwo, meditation1, MeditateState.MEDITATION1);
    }

    @FXML
    void handleRootChakraMeditation2(MouseEvent event) {
        vboxThree.setTranslateX(-450);
        vboxThree.setTranslateY(-400);
        WindowEditor.setTransition(vboxThree, "xy", 0, 0);
        loadNextScene(meditation2ImagePath, "Length: 30 minutes", "Name: Binaural Beats, Subliminal Meditation", vboxThree, meditation2, MeditateState.MEDITATION2);
    }

    @FXML
    void handleRootChakraMeditation3(MouseEvent event) {
        vboxFour.setTranslateX(-450);
        vboxFour.setTranslateY(-600);
        WindowEditor.setTransition(vboxFour, "xy", 0, 0);
        loadNextScene(meditation3ImagePath, "Length: 60 minutes", "Name: Powerful root chakra opening meditation", vboxFour, meditation3, MeditateState.MEDITATION3);
    }
    ...
    private void handleMeditate(String imagePath, MeditateState medState) {
        ...
        if (medState == MeditateState.MEDITATION)
            musicPlayer.playMusic("Resources/Meditation/Root/RootChakraMeditation.mp3");
        else if (medState == MeditateState.MEDITATION1)
            musicPlayer.playMusic("Resources/Meditation/Root/RootChakraMeditation1.mp3");
        else if (medState == MeditateState.MEDITATION2)
            musicPlayer.playMusic("Resources/Meditation/Root/RootChakraMeditation2.mp3");
        else if (medState == MeditateState.MEDITATION3)
            musicPlayer.playMusic("Resources/Meditation/Root/RootChakraMeditation3.mp3");
