...
public class TheHeartPart2GuidedController implements Initializable {
    ...
    private String guidedImagePath = "file:Resources/Meditation/Heart.guided/HeartChakraGuided.png";
    private String guided1ImagePath = "file:Resources/Meditation/Heart.guided/HeartChakraGuided1.png";
    private String guided2ImagePath = "file:Resources/Meditation/Heart.guided/HeartChakraGuided2.png";
    private String guided3ImagePath = "file:Resources/Meditation/Heart.guided/HeartChakraGuided3.png";
    ...
    @FXML
    void handleHeartChakraGuided(MouseEvent event) {
        vboxOne.setTranslateX(-450);
        WindowEditor.setTransition(vboxOne, "x", 450, 0);
        loadNextScene(guidedImagePath, "Length: 27 minutes", "Name: Heart healing meditation", vboxOne, meditation, MeditateState.GUIDED);
    }

    @FXML
    void handleHeartChakraGuided1(MouseEvent event) {
        vboxTwo.setTranslateX(-450);
        vboxTwo.setTranslateY(-200);
        WindowEditor.setTransition(vboxTwo, "xy", 0, 0);
        loadNextScene(guided1ImagePath, "Length: 4 minutes", "Name: Open your heart meditation", vboxTwo, meditation1, MeditateState.GUIDED1);
    }

    @FXML
    void handleHeartChakraGuided2(MouseEvent event) {
        vboxThree.setTranslateX(-450);
        vboxThree.setTranslateY(-400);
        WindowEditor.setTransition(vboxThree, "xy", 0, 0);
        loadNextScene(guided2ImagePath, "Length: 15 minutes", "Name: Heart Chakra Balancing Guided Meditation", vboxThree, meditation2, MeditateState.GUIDED2);
    }

    @FXML
    void handleHeartChakraGuided3(MouseEvent event) {
        vboxFour.setTranslateX(-450);
        vboxFour.setTranslateY(-600);
        WindowEditor.setTransition(vboxFour, "xy", 0, 0);
        loadNextScene(guided3ImagePath, "Length: 15 minutes", "Name: Activating Flow of Heart Chakra Meditation", vboxFour, meditation3, MeditateState.GUIDED3);
    }
    ...
    private void handleMeditate(String imagePath, MeditateState medState) {
        ...
        if (medState == MeditateState.GUIDED)
            musicPlayer.playMusic("Resources/Meditation/Heart.guided/HeartChakraGuided.mp3");
        else if (medState == MeditateState.GUIDED1)
            musicPlayer.playMusic("Resources/Meditation/Heart.guided/HeartChakraGuided1.mp3");
        else if (medState == MeditateState.GUIDED2)
            musicPlayer.playMusic("Resources/Meditation/Heart.guided/HeartChakraGuided2.mp3");
        else if (medState == MeditateState.GUIDED3)
            musicPlayer.playMusic("Resources/Meditation/Heart.guided/HeartChakraGuided3.mp3");
    }
