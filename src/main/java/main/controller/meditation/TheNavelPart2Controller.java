...
public class TheNavelPart2Controller implements Initializable {
    ...
    private String meditationImagePath = "file:Resources/Meditation/Navel/NavelChakra.png";
    private String meditation1ImagePath = "file:Resources/Meditation/Navel/NavelChakra1.png";
    private String meditation2ImagePath = "file:Resources/Meditation/Navel/NavelChakra2.png";
    private String meditation3ImagePath = "file:Resources/Meditation/Navel/NavelChakra3.png";
    ...
    @FXML
    void handleNavelChakraMeditation(MouseEvent event) {
     	vboxOne.setTranslateX(-450);
    	WindowEditor.setTransition(vboxOne, "x", 450, 0);
     	loadNextScene(meditationImagePath, "Length: 3 minutes", "Name: The Navel Chakra Manipuraka Chakra Healing Meditation", vboxOne, meditation, MeditateState.MEDITATION);
    }
    
    @FXML
    void handleNavelChakraMeditation1(MouseEvent event) {
    	vboxTwo.setTranslateX(-450);
     	vboxTwo.setTranslateY(-200);
    	WindowEditor.setTransition(vboxTwo, "xy", 0, 0);
    	loadNextScene(meditation1ImagePath, "Length: 6 minutes", "Name: Activation The Navel Chakra - Healing", vboxTwo, meditation1, MeditateState.MEDITATION1);
    }
    
    @FXML
    void handleNavelChakraMeditation2(MouseEvent event) {
    	vboxThree.setTranslateX(-450);
    	vboxThree.setTranslateY(-400);
    	WindowEditor.setTransition(vboxThree, "xy", 0, 0);
    	loadNextScene(meditation2ImagePath, "Length: 15 minutes", "Name: Solar Plexus Chakra Activation and Balancing", vboxThree, meditation2, MeditateState.MEDITATION2);
    }

    @FXML
    void handleNavelChakraMeditation3(MouseEvent event) {
    	vboxFour.setTranslateX(-450);
    	vboxFour.setTranslateY(-600);
    	WindowEditor.setTransition(vboxFour, "xy", 0, 0);
    	loadNextScene(meditation3ImagePath, "Length: 60 minutes", "Name: Powerful Solar Plexus Chakra Meditation", vboxFour, meditation3, MeditateState.MEDITATION3);
    }
    ...
    private void handleMeditate(String imagePath, MeditateState medState) {
    	...
    	if(medState == MeditateState.MEDITATION)
    		musicPlayer.playMusic("Resources/Meditation/Navel/NavelChakraMeditation.mp3");
    	else if(medState == MeditateState.MEDITATION1)
    		musicPlayer.playMusic("Resources/Meditation/Navel/NavelChakraMeditation1.mp3");
    	else if(medState == MeditateState.MEDITATION2)
    		musicPlayer.playMusic("Resources/Meditation/Navel/NavelChakraMeditation2.mp3");
    	else if(medState == MeditateState.MEDITATION3)
    		musicPlayer.playMusic("Resources/Meditation/Navel/NavelChakraMeditation3.mp3");
